...
- start: make theme activation robust while containers are still starting (f505a8b)
- container: honor dbExclude entries that already include the table prefix (127f39c)
